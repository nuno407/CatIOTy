...
let scream = 0;
let mqtt_topic = "channels/254839/publish/fields/field1/ASQWPEN92V4TRJNS";
...
let Motor = {
  ...
  start: function() {
    ...
    PWM.set(this._motor_control_pin, this._motor_speed, 0.5);
  },
