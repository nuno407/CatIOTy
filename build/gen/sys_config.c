...
const struct mgos_conf_entry sys_config_schema_[123] = {
  {.type = CONF_TYPE_OBJECT, .key = "", .num_desc = 122},
  ...
  {.type = CONF_TYPE_OBJECT, .key = "update", .num_desc = 7},
  ...
  {.type = CONF_TYPE_OBJECT, .key = "blynk", .num_desc = 3},
  {.type = CONF_TYPE_BOOL, .key = "enable", .offset = offsetof(struct sys_config, blynk.enable)},
  {.type = CONF_TYPE_STRING, .key = "server", .offset = offsetof(struct sys_config, blynk.server)},
  {.type = CONF_TYPE_STRING, .key = "auth", .offset = offsetof(struct sys_config, blynk.auth)},
  ...
  {.type = CONF_TYPE_STRING, .key = "document_root", .offset = offsetof(struct sys_config, http.document_root)},
